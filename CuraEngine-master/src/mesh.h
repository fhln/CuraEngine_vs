...
public:
	...
	MeshFace(){ vertex_index[0] = vertex_index[1] = vertex_index[2] = -1; }
};
...
public:
    ...
    Point3 my_min(); //!< min (in x,y and z) vertex of the bounding box
    Point3 my_max(); //!< max (in x,y and z) vertex of the bounding box
