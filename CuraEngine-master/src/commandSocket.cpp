...
void CommandSocket::handleObjectList(Cura::ObjectList* list)
{
    ...
    {
        d->objectToSlice->meshes.emplace_back(d->objectToSlice.get()); // ruct a new mesh and put it into printObject's mesh list.
...
void CommandSocket::sendLayerInfo(int layer_nr, int z, int height)
{
