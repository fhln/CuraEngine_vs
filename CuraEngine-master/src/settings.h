 ...
 * The GCode flavor definition handles this as a big setting to make major or minor modifications修改 to the GCode.
 */
enum EGCodeFlavor
{
/**
 ...
 * Different conversion functions are available for settings to increase code clarity清楚的 and in the future make
