...
/*!
 * Secondary stage in Fused Filament细丝 Fabrication制造 processing: The generated polygons are used in the gcode generation.
 * Some polygons in the SliceDataStorage signify areas which are to be filled with parallel lines, 
 * while other polygons signify the contours轮廓 which should be printed.
 * 
...
private:
    int maxObjectHeight;
    int fileNr; //!< used for sequential printing of objects 连续打印物体
    GCodeExport gcode;
